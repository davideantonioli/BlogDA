...
M2023 <- subset(WFHMean, TIME_PERIOD=="2023")  %>%
  round(digits=2)
M2024 <- subset(WFHMean, TIME_PERIOD=="2024")  %>%
  round(digits=2)
...
A simple measure gives count of the phenomenon. The average percent of workers (employees) that usually work from home in the following years: `r M2019`%; `r M2020`%; `r M2021`%; `r M2022`%; `r M2023`%; `r M2024`%.
